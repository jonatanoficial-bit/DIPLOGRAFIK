...
def pwa_outputs(b,source_hash):
    manifest={
      ...
      "description":"Simulador de governo, economia, eleições, diplomacia, segurança e crises.",
    ...
    precache=sorted(dict.fromkeys(["index.html","404.html","manifest.webmanifest","favicon.svg",*source,*content,*runtime,*pwa]))
...
'''
    meta={"generated_from":"build.config.json","source_sha256":source_hash,"version":b["version"],"service_worker":"sw.js","cache_name":cache_name,"precache_count":len(precache),"precache":precache,"offline_navigation_fallback":"index.html","controlled_updates":True,"manifest":"manifest.webmanifest"}
