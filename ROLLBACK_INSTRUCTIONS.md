...
2. Substitua integralmente a pasta pela build `DIPLOCRAFT v1.7.3 — Fase 21 — Imprensa, Mídia e Opinião Pública`.
...
5. A chave `diplocraft_save_v101` e o schema 3 permanecem compatíveis.
